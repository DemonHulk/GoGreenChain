                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle elevation-2"
                                     src="{{ $usuario->profile_photo_path ? asset('storage/' . $usuario->profile_photo_path) : asset('storage/default-profile.png') }}"
                                     alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center">{{ $usuario->name }}</h3>
                            <p class="text-muted text-center">
                                <i class="fas fa-wallet text-info"></i> 
                                <span class="ml-1">{{ $usuario->username_wallet }}</span>
                            </p>
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <a class="float-right">{{ $usuario->phone }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
